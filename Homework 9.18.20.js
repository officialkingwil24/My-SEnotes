...
// Q2: Write some code that gives us the length of a given string.
    var string = 'Ice Cube';
    var string = 'Lebron James';
    var string = 'Michael B Jordan';
...
// Q3: a: Write some code that converts a string into all capitals
    var str = 'Michael Jordan';
    var str = 'Chris Tucker';
    var str = 'Homer Simpson';
    (str.toUpperCase());
