...
const operationButons = calculator.querySelectorAll('[data-operation]')
...
const previousOperandTextElement = calculator.querySelector('[data-previous-operand]')
const currentOperandTextElement = calculator.querySelector('[data-current-operand]')
